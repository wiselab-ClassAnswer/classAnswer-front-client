<template>
    <Modal ref="baseModal" :width="50" > 
      ...
      <div class="b m-t-10">
          <!-- 그리드 -->
          <Grid ref="busiHistGrid" :paging="false" :dataParams="params" :sortable=true ></Grid> 
      </div>
...
export default {
  ...
  methods: {
      ...
      initGrid() {
          ...
          const $this = this;
          let gridObj = {
              url:'/prct/mng/busiSchdMng/selectListChrgSchdList.hb',
              colModels:[
                {name:'seq'          ,label: '순번'         , width: 5     , align:'center'  },
                {name:'busiNo'       ,label: '업무번호'     , width: 20     , align:'center'  ,hidden : true },
                {name:'busiNm'       ,label: '업무명'       , width: 20     , align:'center'  },
                {name:'schdDivCd'    ,label: '업무상태'     , width: 10     , align:'center'  ,hidden : true },
                {name:'schdDivNm'    ,label: '업무상태'     , width: 10     , align:'center'  },
                {name:'strtDt'       ,label: '시작일자'     , width: 10     , align:'center'  ,formatter:$this.formatDate },
                {name:'endDt'        ,label: '종료일자'     , width: 10     , align:'center'  ,formatter:$this.formatDate },
                {name:'rmrk'         ,label: '비고'         , width: 50     , align:'center'  },
